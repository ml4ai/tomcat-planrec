...
BOOST_FUSION_ADAPT_STRUCT(client::ast::AtomicFormula<client::ast::Variable>, predicate, args, is_negated)
BOOST_FUSION_ADAPT_STRUCT(client::ast::AtomicFormulaSkeleton, predicate, variables)
BOOST_FUSION_ADAPT_STRUCT(client::ast::Action, name, parameters, precondition)
