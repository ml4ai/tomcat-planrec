...
# TODO: line 150ish uses the 10-second heuristic for mapping labels to actions. 
    # In my final paper, describe how this will be changed to 7 seconds, for
    # now, then using a conditional random field algorithm for further
    # development later.
"""
Note to self: Turn this parser script in. Most up to date, even above the
submissions to the planning team. 4 Dec 2022 STA
