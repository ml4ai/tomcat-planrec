...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{../figures/questionLabelProbability_STA.pdf}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{../figures/abstractLabelProbability_STA.pdf}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{../figures/questionLabel_ConditionalProbability_STA.pdf}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{../figures/abstractLabel_ConditionalProbability_STA.pdf}}
...
%% Time Series and Question Count
\clearpage

\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{../figures/QuestionTiming_STA.pdf}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{../figures/QuestionUtterances_Link_STA.pdf}}
    \caption{}
    \end{figure}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{"../figures/Intent_to_Utterances_Link_STA.pdf"}}
    \caption{}
    \end{figure}
\clearpage
