...
BOOST_FUSION_ADAPT_STRUCT(ast::ImplicitlyTypedList, entries)
BOOST_FUSION_ADAPT_STRUCT(ast::ExplicitlyTypedList, entries, type)
BOOST_FUSION_ADAPT_STRUCT(ast::TypedList, explicitly_typed_lists, implicitly_typed_list)
