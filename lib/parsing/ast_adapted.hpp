...
BOOST_FUSION_ADAPT_STRUCT(ast::TypedList<ast::Name>, explicitly_typed_lists, implicitly_typed_list)
BOOST_FUSION_ADAPT_STRUCT(ast::Domain, name, requirements, types, constants)
