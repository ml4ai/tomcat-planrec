...
namespace parser {
    ...
    using typed_list_names_type = rule<class TTypedListNames, ast::TypedList<ast::Name>>;
    BOOST_SPIRIT_DECLARE(typed_list_names_type);

    using typed_list_variables_type = rule<class TTypedListVariables, ast::TypedList<ast::Variable>>;
